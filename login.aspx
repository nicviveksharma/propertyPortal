<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="PropertyPortal.login" %>
            ...
            <div class="container-xxl py-5">
                <div class="container">
                    <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                        ...
                        <p>Login using your email/username and manage your website settings and master data.</p>
                    </div>
                    <div class="row g-4">
