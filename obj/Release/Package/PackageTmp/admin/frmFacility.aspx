...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <ajaxToolkit:ModalPopupExtender ID="modalfacilityity" runat="server" TargetControlID="btnOpenfacilityity"
            ...
            <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                    <asp:Button ID="btnOpenfacilityity" CssClass="btn btn-gradient-primary me-2" runat="server" Text="Add New" />
                </div>
            </div>
