...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <ajaxToolkit:ModalPopupExtender ID="modalcity" runat="server" TargetControlID="btnOpencity"
            ...
            <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                    <asp:Button ID="btnOpencity" CssClass="btn btn-gradient-primary me-2" runat="server" Text="Add New" />
                </div>
            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="forms-sample">
                                    ...
                                    <asp:Button ID="btnCloseCity" CssClass="btn btn-mb-0 btn-danger" runat="server" Text="Close" OnClick="btnCloseCity_Click"/>
                                </div>
                            </div>
                        </div>
                    </div>
